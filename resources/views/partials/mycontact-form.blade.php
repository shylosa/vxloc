  ...
  <div class="row justify-content-center">
    <div class="col-md">
      <div class="card">
        ...
        <!-- Form -->
          <form method="POST" action="{{ route('store') }}" id="mycontact-form">
            @csrf
            ...
            <div class="row">
              ...
              <div id="phones" class="col-sm text-md-center">
                ...
                @endforeach
                <a href="/add-phone" class="col-md-4 float-right js-add-field">Add</a>
              </div>
              ...
              <div id="emails" class="col-sm text-md-center">
                ...
                @endforeach
                <a href="/add-email" class="col-md-4 float-right js-add-field">Add</a>
              </div>
            </div>
